...
<section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"><h2 class="text-lg font-black">Pricing & Stock</h2><div class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4"><label><span class="mb-2 block text-sm font-bold">Price</span><input name="price" type="number" step="0.01" value="<?php echo e(old('price',$product->price)); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-3"></label><label><span class="mb-2 block text-sm font-bold">Discount price</span><input name="discount_price" type="number" step="0.01" value="<?php echo e(old('discount_price',$product->discount_price)); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-3"></label><label><span class="mb-2 block text-sm font-bold">Discount %</span><input name="discount_percent" type="number" value="<?php echo e(old('discount_percent',$product->discount_percent)); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-3"></label><label><span class="mb-2 block text-sm font-bold">Purchase price</span><input name="purchase_price" type="number" step="0.01" value="<?php echo e(old('purchase_price',$product->purchase_price)); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-3"></label><label><span class="mb-2 block text-sm font-bold">Stock quantity</span><input name="stock_qty" type="number" min="0" value="<?php echo e(old('stock_qty',$product->stock_qty)); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-3"></label><label><span class="mb-2 block text-sm font-bold">Stock status</span><select name="stock_status" class="w-full rounded-xl border border-slate-200 px-4 py-3"><option <?php if(old('stock_status',$product->stock_status)==='In Stock'): echo 'selected'; endif; ?>>In Stock</option><option <?php if(old('stock_status',$product->stock_status)==='Out of Stock'): echo 'selected'; endif; ?>>Out of Stock</option></select></label><label><span class="mb-2 block text-sm font-bold">Min order qty</span><input name="min_order_qty" type="number" min="1" value="<?php echo e(old('min_order_qty',$product->min_order_qty)); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-3"></label><label><span class="mb-2 block text-sm font-bold">Max order qty</span><input name="max_order_qty" type="number" min="1" value="<?php echo e(old('max_order_qty',$product->max_order_qty)); ?>" class="w-full rounded-xl border border-slate-200 px-4 py-3"></label></div></section>
