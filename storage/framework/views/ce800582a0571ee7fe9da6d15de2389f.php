        ...
        w.document.write(`
            ...
            <head>
                ...
                <style>
                    ...
                    .invoice-preview-sheet { height: 297mm !important; width: 210mm !important; min-height: 0 !important; max-height: 297mm !important; overflow: hidden !important; box-shadow: none !important; margin: 0 !important; box-sizing: border-box !important; }
                    .invoice-preview-signatures { position: absolute !important; bottom: 9mm !important; left: 12mm !important; right: 12mm !important; }
            ...
            <body class="m-0 bg-white">
                ...
                <script>
                    function fitInvoiceToOnePage() {
                        var sheet = document.querySelector('.invoice-preview-sheet');
                        if (!sheet) return;
                        var footer = sheet.querySelector('.invoice-preview-signatures');
                        if (!footer) return;
                        var contentBottom = footer.offsetTop - 18;
                        var naturalHeight = Math.max(1, sheet.scrollHeight);
                        var available = Math.max(1, contentBottom);
                        var scale = Math.min(1, available / naturalHeight);
                        if (scale < 0.999) {
