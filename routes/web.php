...
use App\Http\Controllers\Admin\ProductImporterController;
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/product-importer', [ProductImporterController::class, 'index'])
            ->middleware('permission:products.create')->name('admin.product-importer.index');
        Route::post('/product-importer/preview', [ProductImporterController::class, 'preview'])
            ->middleware('permission:products.create')->name('admin.product-importer.preview');
        Route::post('/product-importer/import', [ProductImporterController::class, 'import'])
            ->middleware('permission:products.create')->name('admin.product-importer.import');
        ...
        Route::get('/products/image-editor', [AdminController::class, 'productImageEditor'])
            ->middleware('permission:products.edit')->name('admin.products.image-editor');
        Route::post('/products/{product}/image-editor', [AdminController::class, 'productImageEditorSave'])
            ->middleware('permission:products.edit')->name('admin.products.image-editor.save');
        Route::get('/products/image-cleanup', [AdminController::class, 'productImageCleanup'])
            ->middleware('permission:products.delete')->name('admin.products.image-cleanup');
        Route::post('/products/image-cleanup', [AdminController::class, 'productImageCleanupRun'])
            ->middleware('permission:products.delete')->name('admin.products.image-cleanup.run');
