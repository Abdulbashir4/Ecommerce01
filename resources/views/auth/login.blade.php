...
<div class="login-shell">
    ...
    <main class="panel">
        <div class="card">
            <div class="top-actions"><a class="home-link" href="{{ url('/') }}" aria-label="Return to home"><span aria-hidden="true">←</span> Back to store</a></div>
            <div class="heading">
                <h1>Welcome back</h1>
            ...
            <form method="POST" action="{{ url('/login') }}" id="loginForm">
                ...
                <div class="field">
                    ...
                    <div class="input-wrap">
                        ...
                        <input class="input" id="phone" name="phone" type="tel" inputmode="tel" autocomplete="username" value="{{ old('phone') }}" placeholder="01XXXXXXXXX" required autofocus aria-label="Phone number">
                    </div>
                </div>
            ...
            <div class="legal">© {{ date('Y') }} Optimum Biomedical. All rights reserved.</div>
        </div>
    </main>
</div>
<script>
